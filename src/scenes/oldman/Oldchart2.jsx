        ...
        <Box mt={2}>
          ...
          <div>
            ...
            >
              <Box>
                <Header
                  ...
                  subtitle="3년간의 노인 남성/여성 보행자 사고의 피해 분석"
                />
              </Box>
            </Box>
            ...
            >
              ...
              >
                <img
                  alt="성별 및 상해정도에 따른 사고비율"
                  width="100%"
                  height="100%"
                  src="/oldimg/성별 및 상해정도에 따른 사고비율.png"
              ...
              >
                <img
                  alt="노인보행자 연령대별 성별 사고량"
                  width="100%"
                  height="100%"
                  src="/oldimg/노인보행자 연령대별 성별 사고량.png"
                  style={{ cursor: "pointer" }}
                />
              </Box>
              {/*  Sales Quantity 끝 */}
